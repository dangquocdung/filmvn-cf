...
import '../ui/screens/other_other_screen.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case RoutePaths.razorpay:
        ...
        return MaterialPageRoute(builder: (context) => RazorPayment(argument.index));
      ...
      case RoutePaths.braintree:
        ...
        return MaterialPageRoute(builder: (context) => BraintreePaymentScreen(argument.planIndex));
      ...
      case RoutePaths.paytm:
        ...
        return MaterialPageRoute(builder: (context) => PaytmPayment(argument.index));
      case RoutePaths.paystack:
        PaystackPayment argument = args;
        return MaterialPageRoute(builder: (context) => PaystackPayment(argument.index));
