...
class _MultiScreenState extends State<MultiScreen> {
  ...
  return AppBar(
    title: Image.network('${APIData.logoImageUri}${appConfig.config.logo}',
      scale: 1.7,
    ),
    actions: <Widget>[
      IconButton(
          ...
          onPressed: () => Navigator.pushNamed(context, RoutePaths.createScreen,
          ),
      ),
    ],
