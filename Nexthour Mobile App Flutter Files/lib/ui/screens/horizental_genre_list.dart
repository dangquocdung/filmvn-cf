        ...
        itemCount: genres.length,
          ...
          return Container(
            ...
            child: Material(
              ...
              child: InkWell(
                onTap: () {
//                  print(genres.genreList[index].id);
//                  print(genres.genreList[index].name);
                  getGenreData(genres[index].id, movieTvList, genres);
                  Navigator.pushNamed(context, RoutePaths.genreVideos, arguments: VideoGridScreen(genres[index].id, genres[index].name, genreDataList));
//                  Navigator.push(context, CupertinoPageRoute(builder: (context) => VideoGridScreen(genres[index].id, genres[index].name, genreDataList)));
                },
                child: Container(
