  ...
  Future<String> _applyCoupon() async {
    ...
    if (applyCouponResponse.statusCode == 200) {
      ...
      if (validCoupon == true) {
        mFlag = 1;
        setState(() {
          _couponMSG = 'Coupon Applied';
          isCouponApplied = false;
          isDataAvailable = false;
        });
      } else {
        setState(() {
          _couponMSG = 'Coupon has been expired';
          isCouponApplied = false;
          isDataAvailable = false;
        });
      }
          ...
          children: <Widget>[
            ...
            Dismissible(
                ...
                confirmDismiss: (direction) async {
                  ...
                  if (_couponController.text == '') {
                    Navigator.pushNamed(context, RoutePaths.razorpay, arguments: RazorPayment(indexPer));
                  }
                  else {
                    Future.delayed(Duration(seconds: 1)).then((_) {
                      Fluttertoast.showToast(
          ...
          children: <Widget>[
            ...
            Dismissible(
                ...
                confirmDismiss: (direction) async {
                  ...
                  if (_couponController.text == '') {
                    Navigator.pushNamed(context, RoutePaths.paytm, arguments: PaytmPayment(indexPer));
                  }
                  else {
                    Future.delayed(Duration(seconds: 1)).then((_) {
                      Fluttertoast.showToast(
          ...
          children: <Widget>[
            ...
            Dismissible(
                ...
                confirmDismiss: (direction) async {
                  ...
                  if (_couponController.text == '') {
                    Navigator.pushNamed(context, RoutePaths.paystack, arguments: PaystackPayment(indexPer));
          ...
          children: <Widget>[
            ...
            Dismissible(
                ...
                confirmDismiss: (direction) async {
                  ...
                  if (validCoupon != false || _couponController.text == '') {
                    Navigator.pushNamed(context, RoutePaths.stripe, arguments: StripePayment(indexPer, _couponController.text));
                  }
                  Future.delayed(Duration(seconds: 1)).then((_) {
...
//  Braintree payment wallet
          ...
          children: <Widget>[
            ...
            Dismissible(
                ...
                confirmDismiss: (direction) async {
                  ...
                  if (_couponController.text == '') {
                   Navigator.pushNamed(context, RoutePaths.braintree, arguments: BraintreePaymentScreen(indexPer));
                  } else {
                    Future.delayed(Duration(seconds: 1)).then((_) {
                      Fluttertoast.showToast(
                          msg: "Coupon is only applicable to Stripe");
  ...
  void onPayWithPayPal(appConfig, userDetails, indexPer) {
    Navigator.pushNamed(context, RoutePaths.paypal, arguments: PaypalPayment(
      ...
      payAmount: "${appConfig.plans[indexPer].amount}",
...
//  Coupon Dialog
  _couponDialog(BuildContext context) {
    return showDialog(
        context: context,
            ...
            child: Scaffold(
              ...
              body: loading == true ? Center(
                child: CircularProgressIndicator(),) : _scaffoldBody(
                  dailyAmountAp, afterDiscountAmount),
            ),
          ),
          onWillPop: () async {
            return true;
