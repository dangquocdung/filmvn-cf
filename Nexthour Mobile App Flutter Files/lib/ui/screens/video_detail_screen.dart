...
import 'package:nexthour/ui/download/download_episode_page.dart';
...
import 'package:nexthour/ui/shared/download_page.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            seasonEpisodeData  == null ? SizedBox.shrink() : heading("Artist"),
            seasonEpisodeData  == null ? SizedBox.shrink() : SeasonsArtistList(widget.videoDetail),
...
//                  mIFrameUrl.substring(mReadyUrl.length - 4) == ".mp4"
              ...
              _showDialog(i, userDetails.payment);
            }
            else {
              getAllScreens(seasonEpisodeData[i]['id'], "JS", title);
            }
  ...
  void _showDialog(i, userPaymentType) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
